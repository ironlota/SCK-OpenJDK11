 ...
 * <ul>
 *   <li><a
 *       href="http://mishadoff.com/blog/java-magic-part-4-sun-dot-misc-dot-unsafe/">http://mishadoff.com/blog/java-magic-part-4-sun-dot-misc-dot-unsafe/</a>
 *   <li><a
 *       href="http://mydailyjava.blogspot.com/2013/12/sunmiscunsafe.html">http://mydailyjava.blogspot.com/2013/12/sunmiscunsafe.html</a>
 *   <li><a
 *       href="http://zeroturnaround.com/rebellabs/dangerous-code-how-to-be-unsafe-with-java-classes-objects-in-memory/">http://zeroturnaround.com/rebellabs/dangerous-code-how-to-be-unsafe-with-java-classes-objects-in-memory/</a>
 * </ul>
 *
 ...
 * <ul>
 *   <li><a
 *       href="http://www.codeinstructions.com/2008/12/java-objects-memory-structure.html">http://www.codeinstructions.com/2008/12/java-objects-memory-structure.html</a>
 * </ul>
 */
public class UnsafeHelper {
  ...
  public static void copyMemory(
      final Object src, long srcOffset, final Object dest, final long destOffset, final long len) {

    // TODO make this work if destOffset is not STRIDE aligned
    // Preconditions.checkNotNull(src);
    // Preconditions.checkArgument(
    //     len % COPY_STRIDE != 0, "Length (%d) is not a multiple of stride", len);

    // Preconditions.checkArgument(
    //     destOffset % COPY_STRIDE != 0, "Dest offset (%d) is not stride aligned", destOffset);
   ...
   * href="http://www.codeinstructions.com/2008/12/java-objects-memory-structure.html">http://www.codeinstructions.com/2008/12/java-objects-memory-structure.html</a>
   * and <a
   * href="http://stackoverflow.com/a/17348396/88646">http://stackoverflow.com/a/17348396/88646</a>
   *
   * <p>
   *
   * <pre>
  ...
  /**
   * Returns the size of an instance of this class (in bytes). Instances include a header + all
   * fields + padded to 8 bytes. If this is an array, it does not include the size of the elements.
   *
   * @param clazz
   * @return
   */
